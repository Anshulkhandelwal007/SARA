...
- **Dashboard data endpoint with summary statistics** (Sprint 3)
- **Recent activities retrieval** (Sprint 3)
- **Hot leads retrieval** (Sprint 3)
- **Overdue leads retrieval** (Sprint 3)
